 ...
 */
patricia* patricia::_search(char* _key, const patricia* last)
{
	if ( _bitncmp(_key,str,len) ) {
		...
		if(found == 0){
			...
			printf("o valor de count e %d\n", count);
		}else{
			printf("palavra ja marcada\n");
		}	
...
int main(){
	...
	//inserindo asiapacific
	s = (char*)malloc(sizeof(char)*12); 
	strcpy(s,"asiapacific"); 
	tree->add(s,NULL); 
	assert(0==tree->validate());
...
//--------------------------------------------------------------------------------------------
	...
	//realizando uma busca da palavra 
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "africa");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "americ");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra 
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "asiapacific");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra 
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "asi");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra 
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "asia");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra 
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "australia");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "europ");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "europa");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//realizando uma busca da palavra
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "european");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
	
	//--------------------------------------------------------------------
	
	printf("buscando todas as palavras\n\n");
		
	//realizando uma busca da palavra
	keysearch = (char*)malloc(sizeof(char)*12);
	strcpy(keysearch, "america");
	printf("\nrealizando uma busca da palavra %s\n", keysearch);
	tree->_search(keysearch, NULL);
